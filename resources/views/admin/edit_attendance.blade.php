...
@section('content')
    <div class="wrapper">
        <h3 style="text-align: center;margin-top: 20px; margin-bottom: 20px">Edit Attendance </h3>
        {!! Form::open(array('route'=> ['attendance.update', $data->id],'method'=>'PUT', 'class'=>'form-horizontal', 'files'=>true)) !!}

        <div class="wrapper">

            <div class="row col-md-12 {{ $errors->has('std_id') ? 'has-error' : '' }} ">
                {{ Form::label('std_id', ' Student ID :', array('class'=>'control-label col-md-2'))}}
                {{ Form::text('std_id', $data->std_id , array('class'=>'col-md-8 form-control', 'placeholder'=>'  Student ID  '))}}
          ...
          <strong>{{ $errors->first('std_id') }}</strong>
            ...
            <div class="row col-md-12 {{ $errors->has('std_roll') ? 'has-error' : '' }} ">
                ...
                {{ Form::number('std_roll',  $data->std_roll, array('class'=>'col-md-8 form-control', 'placeholder'=>' Student Roll'))}}
          ...
          <strong>{{ $errors->first('class') }}</strong>
                ...
                {{ Form::select('section',  ['null'=>'Select section', 'A'=>'section A','B'=>'section B'], $data->section, array('class'=>'col-md-3 form-control' ))}}
          ...
          <strong>{{ $errors->first('section') }}</strong>
            ...
            <div class="row col-md-12 {{ $errors->has('section') ? 'has-error' : '' }} ">
                ...
                {{ Form::time('in_time',  $data->in_time, array('class'=>'col-md-3 form-control' ))}}
          ...
          <strong>{{ $errors->first('in_time') }}</strong>
                ...
                {{ Form::time('out_time',   $data->out_time, array('class'=>'col-md-3 form-control' ))}}
          ...
          <strong>{{ $errors->first('out_time') }}</strong>
            ...
            <div class="row col-md-12 {{ $errors->has('a_date') ? 'has-error' : '' }} ">
                ...
                {{ Form::date('a_date',  $data->a_date, array('class'=>'col-md-3 form-control ' ))}}
          ...
          <strong>{{ $errors->first('a_date') }}</strong>
                ...
                {{ Form::text('a_status',  $data->a_status, array('class'=>'col-md-3 form-control', 'placeholder'=>' Status  '))}}

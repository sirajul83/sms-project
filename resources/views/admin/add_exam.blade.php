...
@section('content')
    <div class="wrapper">
        <h3 style="text-align: center;margin-top: 20px; margin-bottom: 20px">Add Exam </h3>
        ...
        <div class="wrapper">
            ...
            <div class="row col-md-12 {{ $errors->has('e_name') ? 'has-error' : '' }} ">
                ...
                {{ Form::text('exam_name', '', array('class'=>'col-md-8 form-control', 'placeholder'=>'  Exam Name '))}}
          ...
          <strong>{{ $errors->first('exam_id') }}</strong>
            ...
            <div class="row col-md-12 {{ $errors->has('held_date') ? 'has-error' : '' }} ">
                ...
                {{ Form::date('held_date', '', array('class'=>'col-md-8 form-control'))}}

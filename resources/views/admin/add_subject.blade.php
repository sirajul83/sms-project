...
@section('content');
<h2 style="text-align: center;margin-top: 10px; margin-bottom: 10px;">Add subject </h2><br>
...
<div class="wrapper">
    ...
    <div class="row col-md-12 {{ $errors->has('section') ? 'has-error' : '' }} ">
        ...
        {{ Form::select('sub_name',  ['null'=>'Select Subject', 'Bangla'=>'Bangla','English'=>'English','Social'=>'Social','Phychis'=>'Phychis'], array('class'=>'col-md-3 select_btn' ))}}
    ...
    <div class="row col-md-12 {{ $errors->has('full_mark') ? 'has-error' : '' }} ">
        ...
        {{ Form::number('full_mark',  ' ', array('class'=>'col-md-3 form-control' ))}}

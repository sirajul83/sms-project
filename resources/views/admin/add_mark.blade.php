    ...
    <div class="wrapper">
        ...
        {!! Form::open(array('route'=> 'mark.store', 'class'=>'form-horizontal', 'files'=>true)) !!}
            <div class="row col-md-12 {{ $errors->has('std_id') ? 'has-error' : '' }}">
                ...
                {{ Form::number('std_id', '', array('class'=>'col-md-8 form-control', 'placeholder'=>' Student ID '))}}
            ...
            <div class="row col-md-12 {{ $errors->has('sub_id') ? 'has-error' : '' }}">
                ...
                {{ Form::number('sub_id', '', array('class'=>'col-md-8 form-control', 'placeholder'=>' Subject ID '))}}
            ...
            <div class="row col-md-12" {{ $errors->has('exam_id') ? 'has-error' : '' }}>
                ...
                {{ Form::number('exam_id', '', array('class'=>'col-md-8 form-control', 'placeholder'=>' Exam ID '))}}
            ...
            <div class="row col-md-12 {{ $errors->has('year') ? 'has-error' : '' }} ">
                ...
                {{ Form::select('year',  ['null'=>'Select Year', '2018'=>'2018','2017'=>'2017','2016'=>'2016','2015'=>'2015'], array('class'=>'col-md-3 form-control' ))}}
                @if($errors->has('year'))
                    <span class="help-block" style="display:block">
          <strong>{{ $errors->first('year') }}</strong>
                ...
                {{ Form::number('mark', '', array('class'=>'col-md-3 form-control', 'placeholder'=>' mark ' ))}}
                @if($errors->has('mark'))
                    <span class="help-block" style="display:block">
